...
<button 
  ...
  onclick="window.location.href='<?php echo e(url('admin/template')); ?>'">
  Add Template
</button>
...
$(document).ready(function () {
   $('#templatesTable').DataTable({
    ...
    serverSide: true,
    ajax: {
        url: "<?php echo e(route('templates.list')); ?>",
        type: 'GET',
        data: function (d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/customer/www/qms.lamtans.com/public_html/resources/views/admin/templates.blade.php ENDPATH**/ ?>